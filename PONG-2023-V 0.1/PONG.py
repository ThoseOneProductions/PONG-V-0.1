...
# Load sounds
paddle_hit_sound = pygame.mixer.Sound(r'C:\Users\cobur\Desktop\PONG2023\hit.wav')

# Load background music and play it
pygame.mixer.music.load(r'C:\Users\cobur\Desktop\PONG2023\goodlife.mp3')
pygame.mixer.music.play(-1)  # -1 makes it loop forever

# Load score sound effect
score_sound = pygame.mixer.Sound(r'C:\Users\cobur\Desktop\PONG2023\oof_2.wav')




# Load ball image
brother_face = pygame.image.load(r'C:\Users\cobur\Desktop\PONG2023\Mistiko_Ball_1.png')
